...
export class EventTypeService {
  ...
  findAll() {
    return this.eventTypeSchema.find().populate("parentEventTypeId");
  }

  findOne(id: string) {
    return this.eventTypeSchema.findById(id).populate("parentEventTypeId");
  }

  update(id: string, updateEventTypeDto: UpdateEventTypeDto) {
    return this.eventTypeSchema.findByIdAndUpdate(id, updateEventTypeDto, {new: true});
  }
